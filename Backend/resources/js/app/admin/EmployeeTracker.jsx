...
import { Tag, Progress, DatePicker as AntDatePicker, Button, Pagination, Card } from "antd";
import { 
  CalendarOutlined, 
  CheckCircleOutlined, 
  StarOutlined,
...
function EmployeeTracker() {
    ...
    },
    {
      ...
      render: (name) => (
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-gradient-to-br from-[#EA580C] to-[#F59E0B] rounded-full flex items-center justify-center text-white font-bold text-sm">
            {name.charAt(0)}
          </div>
  ...
  const salesColumns = [
    ...
    },
    {
      ...
      render: (name) => (
        <div className="flex items-center gap-2">
          <UserOutlined className="text-[#F97316]" />
          <span className="font-medium">{name}</span>
        </div>
      ),
    },
    ...
    },
    {
      ...
      key: "grossTotal",
      render: (value) => <span className="text-[#EA580C] font-semibold">{formatCurrency(value)}</span>,
    },
    {
      title: "NET SALES",
      key: "netSales",
      render: (_, record) => <span className="text-[#EA580C] font-semibold">{formatCurrency(record.cashCollected - record.changeGiven)}</span>,
    },
    {
      title: "SR. DISCOUNT",
      key: "seniorDiscount",
  ...
  const performanceColumns = [
    ...
    },
    {
      ...
      render: (value) => (
        <div className="flex items-center gap-2">
          <Progress percent={value} size="small" strokeColor="#F97316" className="w-32" />
    ...
    },
    {
      ...
      render: (value) => (
        <div className="flex items-center gap-2">
          <Progress percent={value} size="small" strokeColor="#F59E0B" className="w-32" />
          <span className="text-sm font-medium">{value}%</span>
        </div>
      ),
    },
    {
      ...
      render: (value) => (
        <div className="flex items-center gap-2">
          <Progress percent={value} size="small" strokeColor="#16A34A" className="w-32" />
          <span className="text-sm font-medium">{value}%</span>
        </div>
      ),
    },
    ...
    <div className="p-6 bg-gradient-to-br from-[#FFF8ED]/80 via-[#FFFDF9] to-[#FFF1E6]/80 min-h-screen">
        ...
        <div className="px-8 py-6 relative">
          ...
          <div className="flex items-center justify-between relative z-10 flex-wrap gap-4">
            <div>
              ...
              <p className="text-white/80 text-sm">Track employee attendance, sales, and performance in one view</p>
            </div>
      ...
      <div>
        <div className="max-w-7xl mx-auto">
          {loading && (
            <div className="bg-[#FFF1E6] border border-[#FFE3C9] text-[#451A03] rounded-xl px-4 py-3 mb-6 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <LoadingIcon size={16} />
                <div className="text-sm">
                  <div className="font-semibold">Fetching latest data from backend...</div>
                  <div className="text-[#EA580C]/80">Date: {selectedDate}</div>
                </div>
              </div>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 mb-6 flex items-start justify-between gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wide">Attendance Today</p>
                  <p className="text-2xl font-bold text-[#451A03]">{presentCount} / {attendanceArray.length} Present</p>
                ...
                <div className="bg-gradient-to-br from-[#FFF1E6] to-[#FFE3C9] rounded-full p-3 text-[#F97316]">
            ...
            <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#16A34A]">{totalTransactions}</p>
                </div>
                <div className="bg-gradient-to-br from-[#E7F6EC] to-[#D3F0DC] rounded-full p-3 text-[#16A34A]">
            ...
            <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#EA580C]">{formatCurrency(totalSales)}</p>
                </div>
                <div className="bg-gradient-to-br from-[#FFF1E6] to-[#FFE3C9] rounded-full p-3 text-[#EA580C]">
            ...
            <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-500">{avgPerformance}%</p>
                </div>
                <div className="bg-gradient-to-br from-[#FEF3E2] to-[#FDE8C4] rounded-full p-3 text-[#D97706]">
          ...
          {/* Filters */}
          <Card className="rounded-xl border border-[#F5EDE0] shadow-sm mb-6">
            <div className="flex flex-wrap gap-4 items-center justify-between">
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center w-full sm:w-auto">
                <div className="w-full sm:w-auto">
                  <label className="text-xs text-[#451A03] font-semibold block mb-1">Select Date</label>
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => setDatePickerOpen(true)}
                      className="w-full sm:w-auto inline-flex items-center justify-between gap-3 px-3 py-2 rounded-xl border border-[#F5EDE0] bg-white text-sm text-[#451A03] hover:border-[#F97316] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#F97316]/30"
                      aria-label="Select date"
                    >
                      <span className="inline-flex items-center gap-2">
                        <CalendarOutlined className="text-[#F97316]" />
                ...
                <div className="w-full sm:w-auto">
                  <label className="text-xs text-[#451A03] font-semibold block mb-1">Search Employee</label>
                  <div className="flex items-center border border-[#F5EDE0] rounded-xl px-3 py-1.5 focus-within:border-[#F97316] transition-all duration-200">
                    <SearchOutlined className="text-[#F97316] text-sm mr-2" />
                    <input
                      type="text"
          ...
          <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm mb-6 overflow-hidden">
            <div className="bg-gradient-to-r from-[#FFF1E6] to-[#FFE3C9]/60 border-b border-[#F5EDE0] px-6 py-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-[#F97316] shadow-sm">
                  <CalendarOutlined />
                </div>
                <span className="font-bold text-[#451A03]">Attendance Overview</span>
                <Tag className="ml-auto text-sm px-3 py-1 rounded-full bg-gradient-to-br from-[#EA580C] to-[#F59E0B] text-white border-none">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-[#FFFBF5] border-b border-[#F5EDE0]">
                    {attendanceColumns.map((col, idx) => (
                      <th key={idx} className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">
                        {col.title}
                      </th>
                    ))}
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#F5EDE0]/70">
                  {filteredAttendance.length === 0 ? (
                    ...
                    filteredAttendance.map((record, idx) => (
                      <tr key={record.id} className="hover:bg-[#FFF8ED]">
          ...
          <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm mb-6 overflow-hidden">
            <div className="bg-gradient-to-r from-[#FFF1E6] to-[#FFE3C9]/60 border-b border-[#F5EDE0] px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-[#451A03]">Staff Sales (Based on POS Checkout)</span>
                <Tag className="ml-auto text-sm px-3 py-1 rounded-full bg-gradient-to-br from-[#16A34A] to-[#22C55E] text-white border-none">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                  ...
                  {filteredSales.length === 0 ? (
                    ...
                    filteredSales.map((record, idx) => (
                      <tr key={record.id} className="hover:bg-[#FFF8ED]">
                        ...
                        <td className="px-4 py-3">
                          <span className="text-[#EA580C] font-semibold">{formatCurrency(record.grossTotal)}</span>
                        </td>
                        <td className="px-4 py-3">
                          <span className="text-[#EA580C] font-semibold">{formatCurrency(record.cashCollected - record.changeGiven)}</span>
                        </td>
                        <td className="px-4 py-3">
                          {record.seniorDiscountCount > 0 ? (
                            <div className="flex flex-col">
                        ...
                        <td className="px-4 py-3">
                          <Tag color="orange">{record.topCategory}</Tag>
                        </td>
                      </tr>
                    ))
                  )}
                ...
                {filteredSales.length > 0 && (
                  <tfoot className="bg-[#FFFBF5] border-t border-[#F5EDE0]">
                    <tr>
                      <td colSpan={4} className="px-4 py-3 text-right font-semibold text-[#451A03]">TOTAL:</td>
          ...
          <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm mb-6 overflow-hidden">
            <div className="bg-gradient-to-r from-[#FFF1E6] to-[#FFE3C9]/60 border-b border-[#F5EDE0] px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-[#451A03]">POS Checkout Transactions</span>
                <Tag className="ml-auto text-sm px-3 py-1 rounded-full bg-gradient-to-br from-[#EA580C] to-[#F59E0B] text-white border-none">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-[#FFFBF5] border-b border-[#F5EDE0]">
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">NO.</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Invoice</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Employee</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Customer</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Date/Time</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Items</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Subtotal</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">SR. Discount</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Total</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Cash</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-[#451A03] uppercase tracking-wider">Change</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#F5EDE0]/70">
                  {pagedPosCheckouts.length === 0 ? (
                    ...
                    pagedPosCheckouts.map((row, idx) => (
                      <tr key={row.id} className="hover:bg-[#FFF8ED]">
                        ...
                        <td className="px-4 py-3 font-semibold text-[#451A03]">{row.itemsCount}</td>
                        <td className="px-4 py-3 text-gray-700">{formatCurrency(row.subtotal)}</td>
                        <td className="px-4 py-3">
                          {row.seniorDiscount ? (
                            <div className="flex flex-col">
                        ...
                        <td className="px-4 py-3 text-[#16A34A] font-semibold">{formatCurrency(row.total)}</td>
            ...
            {posCheckoutTotal > POS_PAGE_SIZE && (
              <div className="flex justify-end px-4 py-3 border-t border-[#F5EDE0] bg-[#FFFBF5]">
                <Pagination
          ...
          {/* Performance Table */}
          <div className="bg-white rounded-xl border border-[#F5EDE0] shadow-sm overflow-hidden">
            <div className="bg-gradient-to-r from-[#FFF1E6] to-[#FFE3C9]/60 border-b border-[#F5EDE0] px-6 py-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-[#F97316] shadow-sm">
                  <StarOutlined />
                </div>
                <span className="font-bold text-[#451A03]">Performance Metrics</span>
                <Tag className="ml-auto text-sm px-3 py-1 rounded-full bg-gradient-to-br from-[#EA580C] to-[#F59E0B] text-white border-none">
                  ...
                  {filteredPerformance.length === 0 ? (
                    ...
                    filteredPerformance.map((record, idx) => (
                      <tr key={record.id} className="hover:bg-[#FFF8ED]">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <Progress percent={record.attendanceRate} size="small" strokeColor="#F97316" className="w-32" />
                            <span className="text-sm font-medium">{record.attendanceRate}%</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <Progress percent={record.productivity} size="small" strokeColor="#F59E0B" className="w-32" />
                            <span className="text-sm font-medium">{record.productivity}%</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <Progress percent={record.qualityScore} size="small" strokeColor="#16A34A" className="w-32" />
          ...
          {/* Footer */}
          <div className="mt-6 text-center text-xs text-gray-400 border-t border-[#F5EDE0] pt-4">
