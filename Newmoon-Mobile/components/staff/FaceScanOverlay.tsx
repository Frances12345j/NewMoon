...
export function FaceScanOverlay({
  ...
  const borderColor = phase === 'mismatch' ? '#F97316' : '#34d399';
  const glowColor = phase === 'mismatch' ? 'rgba(249,115,22,0.25)' : 'rgba(52,211,153,0.22)';
      ...
      <View style={styles.scanStack}>
        ...
        >
          <View style={styles.frameClip}>
            <View style={[styles.glow, { backgroundColor: glowColor }]}></View>
          ...
          <View style={[styles.frame, { borderColor }]}></View>
          <View style={[styles.corner, styles.tl, { borderColor }]}></View>
          <View style={[styles.corner, styles.tr, { borderColor }]}></View>
          <View style={[styles.corner, styles.bl, { borderColor }]}></View>
          <View style={[styles.corner, styles.br, { borderColor }]}></View>
        </View>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  bannerErr: {
    backgroundColor: 'rgba(60,30,15,0.92)',
    borderWidth: 1,
